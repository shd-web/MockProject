 ...
 */
@WebServlet(name="/MyAccountCheck",urlPatterns= {"/MyAccountCheck"})
public class MyAccountCheck extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(returnAb != null) {
            ...
            RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/my_page_detail.jsp");
